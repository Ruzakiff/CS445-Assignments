...
public final class LinkedBag<E> implements BagInterface<E> {
     ...
     * @return True if other is a LinkedBag containing the same objects, with
    ...
    public boolean equals(Object other) {
    	if(other instanceof LinkedBag){
        	...
        	LinkedBag temp=((LinkedBag)other);
    		if(this.getCurrentSize()==temp.getCurrentSize()){
    			Node tempNode=head;
    			while(tempNode!=null){
    				if(getFrequencyOf(tempNode.data)!=temp.getFrequencyOf(tempNode.data)){
    					return false;
    				}
