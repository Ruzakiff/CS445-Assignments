...
public class Queens {
    ...
    public static boolean isFullSolution(int[] partial) {
        ...
        // Since we checked that the solution is complete, and since isFullSolution is called after
        // reject, it must also be valid
        return true;
    }
    ...
    public static int[] next(int[] partial) {
        // Not entirely necessary as with extend, but probably good to make a copy here too
        int[] temp = new int[8];
        int i = 0;
        while (i < 8) {
